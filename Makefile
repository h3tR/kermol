...
kermol.elf: libkermol_objects
	gcc -T linker.ld -o target/x86_64-kermol/debug/kermol.elf target/x86_64-kermol/debug/objects/*.o -ffreestanding -nostdlib -static
